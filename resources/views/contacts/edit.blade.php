                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="age">
                                ...
                                <option value="1" @if($contact->age === 1) checked @endif>～１９歳</option>  
                                <option value="2" @if($contact->age === 2) checked @endif>２０歳～２９歳</option>  
                                <option value="3" @if($contact->age === 3) checked @endif>３０歳～３９歳</option>  
                                <option value="4" @if($contact->age === 4) checked @endif>４０歳～４９歳</option>  
                                <option value="5" @if($contact->age === 5) checked @endif>５０歳～５９歳</option>  
                                <option value="6" @if($contact->age === 6) checked @endif>６０歳～</option>  
                            </select>
                        </div>
                        </div>
