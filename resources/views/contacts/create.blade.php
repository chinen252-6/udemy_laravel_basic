                    ...
                    <div class="flex flex-wrap -m-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="age">
                                ...
                                <option value="3" {{ old('age') == 3 ? 'selected' : '' }}>３０歳～３９歳</option>  
                                <option value="4" {{ old('age') == 4 ? 'selected' : '' }}>４０歳～４９歳</option>  
                                <option value="5" {{ old('age') == 5 ? 'selected' : '' }}>５０歳～５９歳</option>  
                                <option value="6" {{ old('age') == 6 ? 'selected' : '' }}>６０歳～</option>  
                            </select>
                        </div>
                        </div>
